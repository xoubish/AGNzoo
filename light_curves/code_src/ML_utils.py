...
def translate_bitwise_sum_to_labels(bitwise_sum):
    ...
    agnlabels =['SDSS_QSO','WISE_Variable','Optical_Variable','Charisi16','Chen20','Graham15','Liu19','Ward22_wise','Ward22_ztf','bigMAC_dual','Rodriguez06','bigMAC_binary','PG1302','OJ287']
